...
function Profile() {
  ...
  return (
    <div className="mt-5 dark:bg-lightDark bg-white border dark:border-borderDark flex items-center flex-col  box-shadow-light dark:box-shadow rounded-md h-[800px] overflow-auto">
      ...
      <div className="flex w-full flex-col gap-5 py-16 px-16">
        {state === "Profile" ? (
          profile.map((data) => (
            <div
              key={data.key}
