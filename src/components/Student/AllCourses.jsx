    ...
    <div className="section bg-lightLayout dark:bg-lightDark py-10 mt-10 overflow-auto h-[800px]">
      <div className="md:px-5 px-2">
        <div className="flex items-center justify-between md:flex-row flex-col max-md:gap-5">
          ...
          <div className="flex items-center gap-2 border dark:border-borderDark p-5 relative max-md:w-full">
            <div className="absolute top-0 -translate-y-1/2 left-0 text-lg font-semibold px-5">Filter</div>
            <input
            ...
            <FontAwesomeIcon className="text-lg px-3 cursor-pointer bg-black/20 rounded-sm py-3" icon={faMagnifyingGlass} />
          </div>
        </div>
