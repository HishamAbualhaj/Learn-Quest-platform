...
export default function AddCourse({ setAddCoursePopup }) {
  ...
  return (
    <div>
      ...
      ></div>
      <div className="bg-lightDark rounded-sm w-[650px] h-[850px] overflow-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
        <div className="text-center text-white text-xl py-5 border-b border-borderDark">
          Add Course Details
        </div>
